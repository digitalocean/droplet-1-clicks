# Droplet 1-click agent guide (verbatim)

> **Provenance:** Copied from [droplet-1-clicks `.github/agents/1-click-agent.md`](https://github.com/digitalocean/droplet-1-clicks/blob/master/.github/agents/1-click-agent.md). Update this file when upstream changes.
