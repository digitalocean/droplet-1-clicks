...
| Variable | Purpose |
|----------|---------|
| `GRADIENT_KEY` | DigitalOcean Serverless Inference model access key |
...
| `files/opt/apply-gradient-from-env.sh` | Apply Serverless Inference key from env on boot |
