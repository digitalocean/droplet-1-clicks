...
wget https://maven.minecraftforge.net/net/minecraftforge/forge/26.2-65.0.3/forge-26.2-65.0.3-installer.jar -P /opt/minecraft

chown -R minecraft:minecraft /opt/minecraft
chown -R minecraft:minecraft /opt/minecraft/eula.txt
chown -R minecraft:minecraft /opt/minecraft/server.jar

sudo -u minecraft java -jar /opt/minecraft/forge-26.2-65.0.3-installer.jar --installServer
